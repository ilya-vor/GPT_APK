...
requirements = python3,kivy,annotated-types,anyio,certifi,distro,exceptiongroup,h11,httpcore,httpx,idna,numpy,pandas,pandas-stubs,pydantic,pydantic-core,python-dateutil,pytz,six,sniffio,tqdm,types-pytz,typing-extensions,tzdata,openai
...
android.permissions = android.permission.INTERNET, android.permission.WRITE_EXTERNAL_STORAGE, android.permission.REQUEST_COMPANION_RUN_IN_BACKGROUND, android.permission.MANAGE_EXTERNAL_STORAGE, android.permission.READ_EXTERNAL_STORAGE
